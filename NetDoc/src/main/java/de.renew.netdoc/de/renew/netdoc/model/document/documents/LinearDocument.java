...
import de.renew.netdoc.model.document.parts.linear.AbstractLinearDocumentPart;
...
/**
 * Linear NetDoc document.
 *
 * @author Christian Bracker,
 * <a href="mailto:1bracker@informatik.uni-hamburg.de">
 * 1bracker@informatik.uni-hamburg.de</a>
 */
public abstract class LinearDocument extends AbstractLinearDocumentPart
                implements Document {

    /**
     * Creates a new LinearDocument initially not assigned to a target.
     */
    protected LinearDocument() {
        this(null);
    }

    /**
     * Creates a new LinearDocument assigned to the specified target.
     * @param target the documentation target to assign to the new document.
     */
    protected LinearDocument(DocTarget target) {
        super(target);
        this.initialise();
    }
    ...
    protected DocumentPart cloneBase() {
        ...
        Constructor<?> constructor = this.getConstructor(
                        new Class[] { DocTarget.class, String.class });
        if (constructor != null) {
