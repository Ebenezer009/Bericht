...
/**
 * This class creates events for the Document container, especially closing and opening of the container .
 *
...
public class DocumentContainerEvent {
     ...
     */
    public DocumentContainerEvent(Object eventType, DocumentContainer originator) {
     ...
     * @de.renew.require (originator != null)
     */
    public DocumentContainerEvent(Object eventType, DocumentContainer originator, Document involvedDocument) {
