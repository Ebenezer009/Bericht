...
/**
 * This class extends the functionality provided by the abstract class by adding specific
 * implementations and customization options for document formatters and parsers.
 *
...
public class SimpleIOManager extends AbstractIOManager {
     ...
     */
    public SimpleIOManager(DocumentFormatter documentExportFormatter, DocumentFormatter documentInputFormatter,
                           DocumentFormatter documentOutputFormatter, DocumentParser documentParser,
     ...
     * </p>
     * <p>To override implement {@link #setDocumentFilenameExtensionImpl(String)}.</p>
     *
