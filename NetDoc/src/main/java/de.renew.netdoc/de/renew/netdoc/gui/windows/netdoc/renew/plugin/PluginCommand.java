...
/**
 * This class provides the command for the NetDoc Renew plugin.
 *
 * @author Christian Bracker,
 * <a href="mailto:1bracker@informatik.uni-hamburg.de">
 * 1bracker@informatik.uni-hamburg.de</a>
 */
public abstract class PluginCommand extends CH.ifa.draw.util.Command implements Command {
    ...
    public void execute() {
        try {
            ...
            logger.error("Error while executing command '" + this.name() + "' using the nested command '" +
    ...
    public boolean isExecutable() {
        return this.getPlugin().isInitialised() && this.getInnerCommand().isExecutable();
    }
