...
/**
 * Factory providing NetDoc Renew plugin commands.
 *
...
public abstract class PluginCommands {
    ...
    public static PluginCommand getCloseCurrentNetDoc(NetDocPlugin plugin) {
        ...
        PluginCommand returnValue = new PluginCommand(plugin,
                        PluginCommands.NAME_CLOSE_CURRENT_NETDOC) {
            @Override
            protected Command createInnerCommand() {
                return ManagerCommands.getCloseCurrentDocument(
                                this.getPlugin().getContainerManager());
            }
        };
     ...
     */
    public static PluginCommand getConnectCurrentNetDoc(NetDocPlugin plugin,
        ...
        PluginCommand returnValue = new PluginCommand(plugin, GUICommands
                        .getConnectDocumentWindowName(connectDirection)) {
            @Override
            protected Command createInnerCommand() {
                return GUICommands.getConnectCurrentDocumentWindow(
                                this.getPlugin().getContainerManager(),
                                iConnectDirection);
            }
        };
    ...
    public static PluginCommand getOpenCurrentNetDoc(NetDocPlugin plugin) {
        ...
        PluginCommand returnValue = new PluginCommand(plugin,
                        PluginCommands.NAME_OPEN_CURRENT_NETDOC) {
            @Override
            protected Command createInnerCommand() {
                return ManagerCommands.getOpenCurrentDocument(
                                this.getPlugin().getContainerManager());
            }
        };
        assert (returnValue != null) : "Postcondition violated: (returnValue != null)";
    ...
    public static PluginCommand getSaveCurrentNetDoc(NetDocPlugin plugin) {
        ...
        PluginCommand returnValue = new PluginCommand(plugin,
                        PluginCommands.NAME_SAVE_CURRENT_NETDOC) {
            @Override
            protected Command createInnerCommand() {
                return ManagerCommands.getSaveCurrentDocument(
                                this.getPlugin().getContainerManager());
            }
        };
        assert (returnValue != null) : "Postcondition violated: (returnValue != null)";
    ...
    public static PluginCommand getCloseAllNetDocs(NetDocPlugin plugin) {
        ...
        PluginCommand returnValue = new PluginCommand(plugin,
                        PluginCommands.NAME_CLOSE_ALL_NETDOCS) {
            @Override
            protected Command createInnerCommand() {
                return ManagerCommands.getCloseAllDocuments(
                                this.getPlugin().getContainerManager());
            }
        };
        assert (returnValue != null) : "Postcondition violated: (returnValue != null)";
     ...
     * @see ConnectWindow#isValidDirection(Object)
     */
    public static PluginCommand getConnectAllNetDocs(NetDocPlugin plugin,
                                                     Object connectDirection) {
        assert (plugin != null) : "Precondition violated: (plugin != null)";
        assert ConnectWindow.isValidDirection(
                        connectDirection) : "Precondition violated: ConnectWindow.isValidDirection(connectDirection)";
        ...
        PluginCommand returnValue = new PluginCommand(plugin, GUICommands
            ...
            @Override
            protected Command createInnerCommand() {
                return GUICommands.getConnectAllDocumentWindows(
                                this.getPlugin().getContainerManager(),
                                iConnectDirection);
            }
        };
    ...
    public static PluginCommand getOpenAllNetDocs(NetDocPlugin plugin) {
        ...
        PluginCommand returnValue = new PluginCommand(plugin,
                        PluginCommands.NAME_OPEN_ALL_NETDOCS) {
            @Override
            protected Command createInnerCommand() {
                return ManagerCommands.getOpenAllDocuments(
                                this.getPlugin().getContainerManager());
            }
        };
        assert (returnValue != null) : "Postcondition violated: (returnValue != null)";
    ...
    public static PluginCommand getSaveAllNetDocs(NetDocPlugin plugin) {
        ...
        PluginCommand returnValue = new PluginCommand(plugin,
                        PluginCommands.NAME_SAVE_ALL_NETDOCS) {
            @Override
            protected Command createInnerCommand() {
                return ManagerCommands.getSaveAllDocuments(
                                this.getPlugin().getContainerManager());
