...
/**
 * Factory providing ContainerManager commands.
 *
...
public abstract class ManagerCommands {
    ...
    public static class CloseDocument extends SingleDocumentCommand {
         ...
         */
        public CloseDocument(ContainerManager containerManager,
        ...
        protected void executeImpl() throws CommandException {
            try {
                this.getContainerManager().closeDocument(this.getDocument(),
                                false);
            } catch (ContainerException e) {
                throw new CommandException(this, e);
            }

            if (this.getContainerManager()
                            .getDocumentContainer(this.getDocument()) != null) {
    ...
    public static class OpenDocument extends SingleDocumentCommand {
         ...
         */
        public OpenDocument(ContainerManager containerManager,
    ...
    public static class OpenDocumentByTarget extends SingleTargetCommand {
         ...
         */
        public OpenDocumentByTarget(ContainerManager containerManager,
                                    DocTarget docTarget) {
    ...
    public static class SaveDocument extends SingleDocumentCommand {
         ...
         */
        public SaveDocument(ContainerManager containerManager,
        ...
        protected void executeImpl() throws CommandException {
            try {
                this.getContainerManager().getIOManager()
                                .saveDocumentPart(this.getDocument());
            } catch (Exception e) {
                throw new CommandException(this, e);
            }
        }
