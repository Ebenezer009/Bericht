...
public abstract class SingleTargetCommand extends ManagerCommand {
     ...
     */
    protected SingleTargetCommand(ContainerManager containerManager,
                                  DocTarget target) {
    ...
    /**
     * Returns the the target used by this command.
     * @return the the target used by this command.
     * @de.renew.ensure (returnValue != null)
     */
