...
public class DocumentContainerAdapter implements DocumentContainerListener {
     ...
     * #containerClosedImpl(DocumentContainerEvent)}.</p>
     ...
     * <p>To override implement {@link
     * #containerClosingImpl(DocumentContainerEvent)}.</p>
     * @param event the corresponding container event.
     * @de.renew.require (event != null)
     */
    @Override
     ...
     * <p>To override implement {@link
     * #containerOpenedImpl(DocumentContainerEvent)}.</p>
     * @param event the corresponding container event.
     * @de.renew.require (event != null)
     */
    @Override
     ...
     * <p>To override implement {@link
     * #documentClosedImpl(DocumentContainerEvent)}.</p>
     * @param event the corresponding container event.
     * @de.renew.require (event != null)
     */
    @Override
     ...
     * <p>To override implement {@link
     * #documentClosingImpl(DocumentContainerEvent)}.</p>
     * @param event the corresponding container event.
     * @de.renew.require (event != null)
     */
    @Override
     ...
     * <p>To override implement {@link
     * #documentOpenedImpl(DocumentContainerEvent)}.</p>
     * @param event the corresponding container event.
     * @de.renew.require (event != null)
     */
    @Override
