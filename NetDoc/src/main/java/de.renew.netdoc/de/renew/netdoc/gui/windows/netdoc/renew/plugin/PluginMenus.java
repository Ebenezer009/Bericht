...
/**
 * This class is a factory providing NetDoc Renew plugin menus.
 *
...
public abstract class PluginMenus {
    ...
    public static CommandMenu getConnectAllNetDocs(NetDocPlugin plugin) {
        ...
        CommandMenu returnValue = PluginMenus.createNetDocMenu(PluginMenus.NAME_CONNECT_ALL);
        returnValue.add(PluginCommands.getConnectAllNetDocs(plugin, ConnectWindow.DIRECTION_NONE));
        returnValue.add(PluginCommands.getConnectAllNetDocs(plugin, ConnectWindow.DIRECTION_TOP));
        returnValue.add(PluginCommands.getConnectAllNetDocs(plugin, ConnectWindow.DIRECTION_LEFT));
        returnValue.add(PluginCommands.getConnectAllNetDocs(plugin, ConnectWindow.DIRECTION_RIGHT));
        returnValue.add(PluginCommands.getConnectAllNetDocs(plugin, ConnectWindow.DIRECTION_BOTTOM));
    ...
    public static CommandMenu getConnectCurrentNetDoc(NetDocPlugin plugin) {
        ...
        CommandMenu returnValue = PluginMenus.createNetDocMenu(PluginMenus.NAME_CONNECT_CURRENT);
        returnValue.add(PluginCommands.getConnectCurrentNetDoc(plugin, ConnectWindow.DIRECTION_NONE));
        returnValue.add(PluginCommands.getConnectCurrentNetDoc(plugin, ConnectWindow.DIRECTION_TOP));
        returnValue.add(PluginCommands.getConnectCurrentNetDoc(plugin, ConnectWindow.DIRECTION_LEFT));
        returnValue.add(PluginCommands.getConnectCurrentNetDoc(plugin, ConnectWindow.DIRECTION_RIGHT));
        returnValue.add(PluginCommands.getConnectCurrentNetDoc(plugin, ConnectWindow.DIRECTION_BOTTOM));
        assert (returnValue != null) : "Postcondition violated: (returnValue != null)";
    ...
    public static CommandMenu getMain(NetDocPlugin plugin) {
        ...
        CommandMenu returnValue = PluginMenus.createNetDocMenu(PluginMenus.NAME_MAIN);
