...
/**
 * Window listener delegating the events to a list of wrapped window listeners.
 *
...
public class WindowListenerWrapper implements WindowListener {
    ...
    public WindowListenerWrapper(WindowListener[] listenersToWrap) {
        ...
        assert !java.util.Arrays.asList(listenersToWrap).contains(
                        null) : "Precondition violated: !java.util.Arrays.asList(listenersToWrap).contains(null)";
    ...
    public final WindowListener[] getWrappedListeners() {
        ...
        assert !java.util.Arrays.asList(returnValue).contains(
                        null) : "Precondition violated: !java.util.Arrays.asList(returnValue).contains(null)";
