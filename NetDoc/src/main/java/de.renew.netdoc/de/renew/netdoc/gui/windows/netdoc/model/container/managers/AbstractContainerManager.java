...
/**
 * This class creates a manager for the Abstract container .
 *
...
public abstract class AbstractContainerManager implements ContainerManager {
     ...
     * </p>
     * <p>To override implement {@link #addCloseRequestListenerImpl(CloseRequestListener)}.</p>
     *
     ...
     * manager.</p>
     * <p>To override implement {@link #removeCloseRequestListenerImpl(CloseRequestListener)}.</p>
     *
    ...
    public final Enumeration<CloseRequestListener> getCloseRequestListeners() {
        Enumeration<CloseRequestListener> returnValue = this.getCloseRequestListenersImpl();
     ...
     * listeners being notified on changes of documents controlled by this
     * manager.</p>
     * <p>To override implement {@link #addDocumentContainerListenerImpl(DocumentContainerListener)}.</p>
     *
     * @param listenerToAdd the listener to be added.
     * @de.renew.require (listenerToAdd != null)
     */
     ...
     * listeners being notified on changes of documents controlled by this
     * manager.</p>
     * <p>To override implement {@link #removeDocumentContainerListenerImpl(DocumentContainerListener)}.</p>
     *
     * @param listenerToRemove the listener to be removed.
     * @de.renew.require (listenerToRemove != null)
     */
     ...
     * </p>
     * <p>To override implement {@link #getDocumentContainerListenersImpl()}.</p>
     *
    ...
    public final Enumeration<DocumentContainerListener> getDocumentContainerListeners() {
        Enumeration<DocumentContainerListener> returnValue = this.getDocumentContainerListenersImpl();
        assert (returnValue != null) : "Postcondition violated: (returnValue != null)";
     ...
     *
     * @return a collection containing {@link DocumentContainer} instances.
     * @de.renew.ensure (returnValue != null)
     * @de.renew.ensure ! returnValue.contains(null)
     */
    @Override
    public final Collection<DocumentContainer> getDocumentContainers() {
        Collection<DocumentContainer> returnValue = this.getDocumentContainersImpl();
        assert (returnValue != null) : "Postcondition violated: (returnValue != null)";
     ...
     * <p>To override implement {@link #getDocumentContainerImpl(Document)}.</p>
     *
     ...
     * <p>To override implement {@link #closeDocumentImpl(Document, boolean)}.</p>
     *
     ...
     *                   not be closed and a closing event will be sent instead.
     * @throws ContainerException if the document could not be closed.
     * @de.renew.require (document != null)
     */
    @Override
    public final void closeDocument(Document document, boolean forceClose) throws ContainerException {
        assert (document != null) : "Precondition violated: (document != null)";
     ...
     */
    @Override
    public final DocumentContainer openDocument(Document documentToOpen) throws ContainerException {
     ...
     */
    @Override
    public final DocumentContainer openDocument(DocTarget docTarget) throws ContainerException {
    ...
    protected void fireDocumentContainerEvent(DocumentContainerEvent event) {
        Enumeration<DocumentContainerListener> listenerEnum = this.getDocumentContainerListeners();

        if (event.getType().equals(DocumentContainerEvent.CONTAINER_CLOSED)) {
            while (listenerEnum.hasMoreElements()) {
                (listenerEnum.nextElement()).containerClosed(event);
            }
        } else if (event.getType().equals(DocumentContainerEvent.CONTAINER_CLOSING)) {
            while (listenerEnum.hasMoreElements()) {
                (listenerEnum.nextElement()).containerClosing(event);
            }
        } else if (event.getType().equals(DocumentContainerEvent.CONTAINER_OPENED)) {
            while (listenerEnum.hasMoreElements()) {
                (listenerEnum.nextElement()).containerOpened(event);
            }
        } else if (event.getType().equals(DocumentContainerEvent.DOCUMENT_CLOSED)) {
            while (listenerEnum.hasMoreElements()) {
                (listenerEnum.nextElement()).documentClosed(event);
            }
        } else if (event.getType().equals(DocumentContainerEvent.DOCUMENT_CLOSING)) {
            while (listenerEnum.hasMoreElements()) {
                (listenerEnum.nextElement()).documentClosing(event);
            }
        } else if (event.getType().equals(DocumentContainerEvent.DOCUMENT_OPENED)) {
            while (listenerEnum.hasMoreElements()) {
    ...
    //The empty enumeration can obviously be cast to an arbitrary generic type.
    ...
    protected void addDocumentContainerListenerImpl(DocumentContainerListener listenerToAdd) {
        ...
        DocumentContainerListener[] newListeners = new DocumentContainerListener[oldListeners.length + 1];
        System.arraycopy(oldListeners, 0, newListeners, 0, oldListeners.length);
        newListeners[oldListeners.length] = listenerToAdd;
    ...
    protected Enumeration<DocumentContainerListener> getDocumentContainerListenersImpl() {
        return Collections.enumeration(Arrays.asList(this._documentContainerListeners));
    }
    ...
    protected DocumentContainer getDocumentContainerImpl(Document document) {
        Iterator<DocumentContainer> containerIterator = this.getDocumentContainers().iterator();
     ...
     * @de.renew.require (document != null)
     */
    protected void closeDocumentImpl(Document document, boolean forceClose) throws ContainerException {
    ...
    protected class ContainerMap extends AbstractDocumentMap {
        ...
        protected Collection<Document> getDocumentsImpl() {
            ...
            DocumentContainer[] containers =
                    AbstractContainerManager.this.getDocumentContainers().toArray(new DocumentContainer[0]);
