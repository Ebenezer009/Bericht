...
/**
 * This class includes the Abstract NetDoc document container.
 *
...
public abstract class AbstractDocumentContainer implements DocumentContainer {
     ...
     */
    @Override
    public final void closeDocument(Document documentToClose, boolean forceClose) {
     ...
     */
    @Override
    public final void openDocument(Document documentToOpen) throws ContainerException {
     ...
     *
     * @return a collection of {@link Document} instances.
     * @de.renew.ensure (returnValue != null)
     ...
     * @de.renew.require (documentToClose != null)
     */
    protected abstract void closeDocumentImpl(Document documentToClose, boolean forceClose);
