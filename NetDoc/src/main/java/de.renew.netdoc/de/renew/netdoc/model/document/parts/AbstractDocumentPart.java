...
public abstract class AbstractDocumentPart
                implements DocumentPart, Serializable {
    ...
    public void setModified(boolean isModified) {
        ...
        if (!isModified) {
            DocumentPart[] subParts = this.getParts()
                            .toArray(new DocumentPart[0]);
     ...
     * #addStructureChangeListenerImpl(StructureChangeListener)}.</p>
     ...
     * <p>To override implement {@link
     * #removeStructureChangeListenerImpl(StructureChangeListener)}.</p>
     ...
     * <p>To override implement {@link
     * #getStructureChangeListenersImpl()}.</p>
    ...
    public final Enumeration<StructureChangeListener> getStructureChangeListeners() {
        Enumeration<StructureChangeListener> returnValue = this
                        .getStructureChangeListenersImpl();
        assert (returnValue != null) : "Postcondition violated: (returnValue != null)";
     ...
     * <p>To override implement {@link
     * #addTextChangeListenerImpl(TextChangeListener)}.</p>
     * @param listenerToAdd the listener to be added.
     * @de.renew.require (listenerToAdd != null)
     */
    @Override
     ...
     * being notified on text changes of this document part.</p>
     * <p>To override implement {@link
     * #removeTextChangeListenerImpl(TextChangeListener)}.</p>
     * @param listenerToRemove the listener to be removed.
     * @de.renew.require (listenerToRemove != null)
     */
    @Override
    ...
    public final Enumeration<TextChangeListener> getTextChangeListeners() {
        Enumeration<TextChangeListener> returnValue = this
                        .getTextChangeListenersImpl();
        assert (returnValue != null) : "Postcondition violated: (returnValue != null)";
     ...
     */
    @Override
    public final void setPart(DocumentPart part)
                    throws IllegalArgumentException {
        ...
        if (constructor != null) {
            ...
            if (constructor == null) {
                throw new Error("Could not find a default constructor. "
                                + "cloneBase() must be overridden by sub class. "
    ...
    protected void fireStructureChangeEvent(StructureChangeEvent event) {
        Enumeration<StructureChangeListener> listenerEnum = this
    ...
    protected void fireTextChangeEvent(TextChangeEvent event) {
        Enumeration<TextChangeListener> listenerEnum = this
    ...
    protected void addStructureChangeListenerImpl(StructureChangeListener listenerToAdd) {
        ...
        StructureChangeListener[] newListeners = new StructureChangeListener[oldListeners.length
                        + 1];
    ...
    protected Enumeration<StructureChangeListener> getStructureChangeListenersImpl() {
        return Collections.enumeration(
                        Arrays.asList(this._structureChangeListeners));
    }
    ...
    protected void addTextChangeListenerImpl(TextChangeListener listenerToAdd) {
        ...
        TextChangeListener[] newListeners = new TextChangeListener[oldListeners.length
                        + 1];
        System.arraycopy(oldListeners, 0, newListeners, 0, oldListeners.length);
        newListeners[oldListeners.length] = listenerToAdd;
    ...
    protected Enumeration<TextChangeListener> getTextChangeListenersImpl() {
        return Collections
                        .enumeration(Arrays.asList(this._textChangeListeners));
    }
     ...
     * @de.renew.require (partName != null)
     */
    protected void removePartImpl(String partName)
                    throws IllegalArgumentException {
     ...
     * @de.renew.require (part != null)
     */
    protected void setPartImpl(DocumentPart part)
                    throws IllegalArgumentException {
    ...
    protected String getVersionImpl() {
        return DocumentParts.NETDOC_TEX_UNIT_VERSION_PREFIX
                        + DocumentParts.NETDOC_TEX_UNIT_VERSION_NUMBER;
    }
