...
/**
 * This class provides the factory, which provides the window commands for the ContainerManager.
 *
...
public abstract class GUICommands {
     ...
     *
     */
    public static Command getConnectCurrentDocumentWindow(ContainerManager containerManager, Object connectDirection) {
        ...
        Command returnValue = new CurrentDocumentCommand(containerManager) {
            ...
            protected Command createCommand(Document document) {
                return new ConnectDocumentWindow(iContainerManager, document, iConnectDirection);
            }

            @Override
            protected String getNameImpl() {
                return GUICommands.getConnectDocumentWindowName(iConnectDirection);
            }
        };
     ...
     *
     */
    public static Command getConnectAllDocumentWindows(ContainerManager containerManager, Object connectDirection) {
        assert (containerManager != null) : "Precondition violated: (containerManager != null)";
        assert ConnectWindow.isValidDirection(connectDirection) :
                "Precondition violated: " + "ConnectWindow.isValidDirection(connectDirection)";
    ...
    /**
     * Command for Connect-Document-Window .
     *
     * @author Christian Bracker,
     * <a href="mailto:1bracker@informatik.uni-hamburg.de">
     * 1bracker@informatik.uni-hamburg.de</a>
    ...
    private static class ConnectDocumentWindow extends SingleDocumentCommand {
         ...
         *
         */
        public ConnectDocumentWindow(ContainerManager containerManager, Document documentToConnect,
        ...
        protected void executeImpl() throws CommandException {
            DocumentContainer container = this.getContainerManager().getDocumentContainer(this.getDocument());

            if (container == null) {
                throw new CommandException(this, "Document window not open");
            }
            if (!(container instanceof Window)) {
                throw new CommandException(this, "Document container is not a window");
            }

            new ConnectWindow((Window) container, this.getConnectDirection()).execute();
        }
