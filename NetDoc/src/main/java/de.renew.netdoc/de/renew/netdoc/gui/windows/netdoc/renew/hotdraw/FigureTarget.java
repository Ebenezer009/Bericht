...
/**
 * This class provides the documentation target for the HotDraw figure.
 * <p>
...
public class FigureTarget extends AbstractDocTarget {
     ...
     */
    private static Map<Figure, FigureTarget> instances =
            Collections.synchronizedMap(new HashMap<Figure, FigureTarget>());
