...
/**
 * This class holds the Structure change event.
 *
...
public class StructureChangeEvent {
     ...
     * @de.renew.require (originator != null)
     */
    public StructureChangeEvent(Object eventType, DocumentPart originator, DocumentPart involvedPart) {
     ...
     */
    public StructureChangeEvent(Object eventType, DocumentPart originator, int changeIndex) {
     ...
     * @de.renew.require (changeIndex > = - 1)
     */
    public StructureChangeEvent(Object eventType, DocumentPart originator, DocumentPart involvedPart, int changeIndex) {
    ...
    /**
     * Returns the document part involved in this event (e.g. that has been
     * added/removed).
     *
     * @return the document part involved in this event;<br>
