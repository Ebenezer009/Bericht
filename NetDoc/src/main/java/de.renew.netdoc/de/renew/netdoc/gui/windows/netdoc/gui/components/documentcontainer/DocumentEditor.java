...
public class DocumentEditor extends SingleDocumentContainerComponent {
    ...
    protected void removeEditorParts(Document document) {
        document.setPart(((DocumentEditor.TextDocumentPart) document.getPart(
                DocumentParts.NAME_NETDOC_AUTHOR)).getWrappedPart());
        document.setPart(
                ((DocumentEditor.TextDocumentPart) document.getPart(DocumentParts.NAME_NETDOC_TITLE)).getWrappedPart());
        document.setPart(((DocumentEditor.TextDocumentPart) document.getPart(
