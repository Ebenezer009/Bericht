...
public class URLs {
    ...
    public static URL append(URL base, String relativePathToAppend) throws MalformedURLException {
        ...
        if (url.charAt(url.length() - 1) != getSeparator()) {
            url = url + getSeparator();
        }
        URL returnValue = new URL(url + relativePathToAppend);
    ...
    public static String getFilename(URL url) {
        ...
        int sepIndex = returnValue.lastIndexOf(getSeparator());
        if (sepIndex >= 0) {
    ...
    public static URL getParent(URL url) {
        ...
        int sepIndex = urlString.lastIndexOf(getSeparator());
     ...
     * @throws IOException if an I/O error occured while opening the stream.
     * @de.renew.require (resource ! = null)
     * @de.renew.ensure (returnValue ! = null)
     */
