...
public abstract class SingleDocumentCommand extends ManagerCommand {
     ...
     */
    protected SingleDocumentCommand(ContainerManager containerManager,
                                    Document document) {
    ...
    /**
     * Returns the the document used by this command.
     * @return the the document used by this command.
     * @de.renew.ensure (returnValue != null)
     */
