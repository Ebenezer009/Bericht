...
/**
 * This class is the Renew-Plugin for NetDoc.
 *
...
public class NetDocPlugin extends PluginAdapter {
    ...
    public static NetDocPlugin getCurrent() {
        Iterator<IPlugin> it = PluginManager.getInstance().getPluginsProviding("de/renew").iterator();
        while (it.hasNext()) {
     ...
     * specified location.
     *
     * @param location a URL pointing to the jar file or directory
    ...
    public void init() {
        ...
        this._containerManager.addDocumentChangeListener(this.getDocumentListener());
        this._containerManager.addDocumentContainerListener(this.getDocumentListener());
    ...
    public void updateMenu() {
        ((GUIContainerManager) this.getContainerManager()).getGUIPlugin().getGui().menuStateChanged();
    }
     ...
     * The document listener used by this plugin.
     */
    private class DocumentListener extends DocumentContainerAdapter implements DocumentChangeListener {
