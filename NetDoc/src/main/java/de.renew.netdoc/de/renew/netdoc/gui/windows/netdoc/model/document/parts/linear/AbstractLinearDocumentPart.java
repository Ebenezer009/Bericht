...
/**
 * This class includes the Abstract Linear NetDoc document part.
 *
 * @author Christian Bracker,
 * <a href="mailto:1bracker@informatik.uni-hamburg.de">
 * 1bracker@informatik.uni-hamburg.de</a>
 */
public abstract class AbstractLinearDocumentPart extends AbstractDocumentPart implements LinearDocumentPart {
     ...
     * will be appended.</p>
     * <p>To override implement {@link #addPartAtImpl(int, DocumentPart)}.</p>
     *
     ...
     */
    @Override
    public final void addPartAt(int index, DocumentPart partToAdd) throws IllegalArgumentException {
        assert (index >= 0) : "Precondition violated: (index >= 0)";
        assert (index <= this.getPartCount()) : "Precondition violated: (index <= this.getPartCount())";
     ...
     * <p>To override implement {@link #setPartAtImpl(int, DocumentPart)}.</p>
     *
     ...
     */
    @Override
    public final void setPartAt(int index, DocumentPart part) throws IllegalArgumentException {
        assert (index >= 0) : "Precondition violated: (index >= 0)";
        assert (index < this.getPartCount()) : "Precondition violated: (index < this.getPartCount())";
     ...
     * @de.renew.require (partToAppend != null)
     */
    protected void appendPartImpl(DocumentPart partToAppend) throws IllegalArgumentException {
    ...
    /**
     * Removes the subpart at the specified index.
     *
     * @param index the index of the part to be removed.
     * @throws IllegalArgumentException if this part was unmodifiable.
     * @de.renew.require (index > = 0)
    ...
    protected int indexOfPartImpl(String partName) {
        ListIterator<DocumentPart> partIterator = this.getPartList().listIterator();
        while (partIterator.hasNext()) {
