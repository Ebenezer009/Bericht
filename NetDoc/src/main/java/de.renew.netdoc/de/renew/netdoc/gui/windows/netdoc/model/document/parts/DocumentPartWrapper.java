...
/**
 * This class includes the Document part wrapper
 */
public class DocumentPartWrapper implements DocumentPart {
    ...
    protected Object cloneImpl() {
        Constructor<?> constructor = this.getConstructor(new Class[]{DocumentPart.class});
        Object[] parameters = new Object[]{this.getWrappedPart()};
        if (constructor == null) {
            throw new Error("Could not find a default constructor. " + "cloneImpl() must be overridden by sub class. " +
        ...
        try {
            ...
            throw new Error("Error while creating clone using default constructor. " +
                    "cloneImpl() must be overridden by sub class. " + "Class: " + this.getClass().getName(), e);
        }
